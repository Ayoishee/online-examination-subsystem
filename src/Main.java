public class Main {
    public static void main(String[] args) {
        ...
        // -------- Part A: Factory Method (Exam provisioning) --------
        ExamFactory examFactory = new MidtermExamFactory();
        Exam exam = examFactory.createExam();   // "Midterm Exam"

        // -------- Part C: Builder (Exam Configuration) --------
        ExamConfiguration config = new ExamBuilder()
                ...
                .enableShuffle()
                .enableAutoSubmit()    // calculator NOT allowed (left default = false)
                .build();

        // -------- Part D: Question Sourcing (Strategy / DI) --------
        ...
        // Pull five questions from the bank through the abstract factories.
